...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/Applications/XAMPP/xamppfiles/htdocs/python-deploy'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/Applications/XAMPP/xamppfiles/htdocs/python-deploy/bin/deactivate.nu'
